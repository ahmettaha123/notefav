...
export const metadata = {
  ...
  description: 'NoteFav'ın zengin metin editörü, SMART hedef şablonları, gruplarla işbirliği ve daha fazla özelliğini keşfedin. Daha verimli ve organize olmak için NoteFav\'ı deneyin.',
  ...
  openGraph: {
    title: 'NoteFav Özellikleri - Not Alma ve Hedef Planlama Uygulaması',
    description: 'NoteFav'ın zengin metin editörü, SMART hedef şablonları, gruplarla işbirliği ve daha fazla özelliğini keşfedin.',
  }
}
